...
import { assertFailure, assertStrictSuccess, assertSuccess, HyphenatedString, NumberFromString } from './helpers'
...
describe('dictionary', () => {
  ...
  describe('is', () => {
    ...
    it('should accepts an array if the codomain is `unknown`', () => {
  ...
  describe('decode', () => {
    ...
    it('should fail decoding an invalid value', () => {
      ...
      const T2 = t.dictionary(HyphenatedString, t.unknown)
      assertFailure(T2.decode([1]), [
