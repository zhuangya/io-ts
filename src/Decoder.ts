...
import { Schemable, memoize, WithUnion, Literal, WithRefinement } from './Schemable'
 ...
 * @since 2.2.0
 */
export const decoder: Applicative1<URI> & Alternative1<URI> & Schemable<URI> & WithUnion<URI> & WithRefinement<URI> = {
  URI,
  map: (fa, f) => ({
